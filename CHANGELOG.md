...
- 口径层：SKILL.md（路由表 / 碰撞表 / 输出合同 / 红旗 RF01–RF28 / 口诀 1.x–7.x）+ expert_claims.md 134 条主张（窗口 2026-02-11 ~ 2026-08-29，dump 2025-07-11 起，门禁切片非全账号）。
...
- 文档：expert_claims 语料边界声明、SKILL.md 发稿前自查（编造/进口/升格/传记/GEO 幻觉五查）、RF18 复核钉死（#125 在库、G7 判常识，不采用是审过非漏采）、附录B 红旗清单自正文口诀反推（不引外部来源）。
