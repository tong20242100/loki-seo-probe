...
来源 `expert_claims.md` 附录B（自正文 134 条口诀反推的红线行为汇总，每条可回查口诀出处）。
...
发稿前自查（合同闸门，命中即改，改不了的在证据等级行暴露）：**编造**——id / 数字 / 站点名无源；**进口**——常识 checklist 混进口诀（密度榜、外链建设、GEO 作业、title 字符数）；**升格**——（降）/ 单点 / asserted 被写成定律；**传记**——用户要审站、回复在讲 Loki 本人；**GEO 幻觉**——语料明说无 how-to 的领域给出了作业清单。
